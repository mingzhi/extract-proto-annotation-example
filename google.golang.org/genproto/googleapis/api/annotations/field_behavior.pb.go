...
func (FieldBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_google_api_field_behavior_proto_enumTypes[0].EnumDescriptor
}
...
var file_google_api_field_behavior_proto_extDescs = []protoiface.ExtensionDescV1{
	{
...
var (
	...
	E_FieldBehavior = &file_google_api_field_behavior_proto_extDescs[0]
)
...
var file_google_api_field_behavior_proto_enumTypes = make([]prototype.Enum, 1)
...
var file_google_api_field_behavior_proto_depIdxs = []int32{
	1, // google.api.field_behavior:extendee -> google.protobuf.FieldOptions
	0, // google.api.field_behavior:type_name -> google.api.FieldBehavior
...
func file_google_api_field_behavior_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		LegacyExtensions:  file_google_api_field_behavior_proto_extDescs,
	}.Build()
	File_google_api_field_behavior_proto = out.File
	file_google_api_field_behavior_proto_enumTypes = out.Enums
