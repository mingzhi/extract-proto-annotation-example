...
var file_google_api_http_proto_depIdxs = []int32{
	1, // google.api.Http.rules:type_name -> google.api.HttpRule
	2, // google.api.HttpRule.custom:type_name -> google.api.CustomHttpPattern
	1, // google.api.HttpRule.additional_bindings:type_name -> google.api.HttpRule
