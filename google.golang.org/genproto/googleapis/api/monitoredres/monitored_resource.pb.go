...
var file_google_api_monitored_resource_proto_depIdxs = []int32{
	5, // google.api.MonitoredResourceDescriptor.labels:type_name -> google.api.LabelDescriptor
	6, // google.api.MonitoredResourceDescriptor.launch_stage:type_name -> google.api.LaunchStage
	3, // google.api.MonitoredResource.labels:type_name -> google.api.MonitoredResource.LabelsEntry
	7, // google.api.MonitoredResourceMetadata.system_labels:type_name -> google.protobuf.Struct
	4, // google.api.MonitoredResourceMetadata.user_labels:type_name -> google.api.MonitoredResourceMetadata.UserLabelsEntry
