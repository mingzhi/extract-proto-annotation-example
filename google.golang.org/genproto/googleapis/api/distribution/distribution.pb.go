...
var file_google_api_distribution_proto_depIdxs = []int32{
	1, // google.api.Distribution.range:type_name -> google.api.Distribution.Range
	2, // google.api.Distribution.bucket_options:type_name -> google.api.Distribution.BucketOptions
	3, // google.api.Distribution.exemplars:type_name -> google.api.Distribution.Exemplar
	4, // google.api.Distribution.BucketOptions.linear_buckets:type_name -> google.api.Distribution.BucketOptions.Linear
	5, // google.api.Distribution.BucketOptions.exponential_buckets:type_name -> google.api.Distribution.BucketOptions.Exponential
	6, // google.api.Distribution.BucketOptions.explicit_buckets:type_name -> google.api.Distribution.BucketOptions.Explicit
	7, // google.api.Distribution.Exemplar.timestamp:type_name -> google.protobuf.Timestamp
	8, // google.api.Distribution.Exemplar.attachments:type_name -> google.protobuf.Any
	8, // starting offset of method output_type sub-list
	8, // starting offset of method input_type sub-list
	8, // starting offset of extension type_name sub-list
	8, // starting offset of extension extendee sub-list
