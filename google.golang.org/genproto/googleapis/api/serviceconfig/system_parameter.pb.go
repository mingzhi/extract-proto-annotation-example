...
var file_google_api_system_parameter_proto_depIdxs = []int32{
	1, // google.api.SystemParameters.rules:type_name -> google.api.SystemParameterRule
	2, // google.api.SystemParameterRule.parameters:type_name -> google.api.SystemParameter
