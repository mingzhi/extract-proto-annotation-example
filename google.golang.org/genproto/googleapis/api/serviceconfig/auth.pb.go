...
var file_google_api_auth_proto_depIdxs = []int32{
	1, // google.api.Authentication.rules:type_name -> google.api.AuthenticationRule
	2, // google.api.Authentication.providers:type_name -> google.api.AuthProvider
	3, // google.api.AuthenticationRule.oauth:type_name -> google.api.OAuthRequirements
	4, // google.api.AuthenticationRule.requirements:type_name -> google.api.AuthRequirement
	4, // starting offset of method output_type sub-list
	4, // starting offset of method input_type sub-list
	4, // starting offset of extension type_name sub-list
	4, // starting offset of extension extendee sub-list
