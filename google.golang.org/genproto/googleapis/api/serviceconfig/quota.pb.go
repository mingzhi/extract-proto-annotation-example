...
var file_google_api_quota_proto_depIdxs = []int32{
	2, // google.api.Quota.limits:type_name -> google.api.QuotaLimit
	1, // google.api.Quota.metric_rules:type_name -> google.api.MetricRule
	3, // google.api.MetricRule.metric_costs:type_name -> google.api.MetricRule.MetricCostsEntry
	4, // google.api.QuotaLimit.values:type_name -> google.api.QuotaLimit.ValuesEntry
