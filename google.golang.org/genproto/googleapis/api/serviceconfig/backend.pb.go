...
func (BackendRule_PathTranslation) Descriptor() protoreflect.EnumDescriptor {
	return file_google_api_backend_proto_enumTypes[0].EnumDescriptor
}
...
var file_google_api_backend_proto_enumTypes = make([]prototype.Enum, 1)
...
var file_google_api_backend_proto_depIdxs = []int32{
	2, // google.api.Backend.rules:type_name -> google.api.BackendRule
	0, // google.api.BackendRule.path_translation:type_name -> google.api.BackendRule.PathTranslation
...
func file_google_api_backend_proto_init() {
	...
	file_google_api_backend_proto_enumTypes = out.Enums
